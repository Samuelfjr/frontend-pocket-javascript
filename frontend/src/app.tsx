...
import { Dialog, DialogClose, DialogContent, DialogDescription, DialogTitle, DialogTrigger } from './components/ui/ui/dialog'
import { Input } from './components/ui/ui/input'
import { Label } from './components/ui/ui/label'
import { RadioGroup, RadioGroupIndicator, RadioGroupItem } from './components/ui/ui/radio-group'
              ...
              <div className='flex flex-col gap-2'>
                ...
                <RadioGroup>
                  <RadioGroupItem value='1'>
                    <RadioGroupIndicator />
                      <span className='text-sm font-medium leading-none text-zinc-300'>1x na semana</span>
